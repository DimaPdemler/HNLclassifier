...
activation=F.tanh
hidden_layers = [512 for i in range(25)]
prefix='try3'

#! copied from try 0. tanh and adamw custom Beta 1 adamw optimizer
...
optimizer = torch.optim.AdamW(model.parameters(), lr=0.002,betas=(0.99,0.999))

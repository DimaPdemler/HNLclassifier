...
def Energychecker(input, output, batch_index):
    ...
    print("etot calculated vs predicted of batch", batch_index, Etot, output)
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (data, target) in enumerate(train_dataloader):
            # for batch_index in range(0,25):
            #     input_e=data[batch_index,:]
            #     output_e=target[batch_index,-1]
            #     Energychecker(input_e, output_e, batch_index)
            # print(data[0,:])
            # print(target[0,-1])
            # assert False

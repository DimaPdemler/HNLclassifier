...
from DD_data_extractor_git import outlier_normalization, generate_random_data, exponential_cdf, outlier_normalization,flatten_2D_list,bucketize, call_dict_with_list
...
class KinematicDataset(Dataset):
    ...
    def generate_data(self, normalize=True):
        ...
        output_half=l_output2[:,0,:] #! for one pair
        ...
        # print("data shape", self.current_data.shape)
        # print("labels shape", self.current_labels.shape)
        # self.seed +=15
